...
//       className="w-72 rounded-xl border border-gray-700 cursor-pointer hover:scale-105 transition"
//       onClick={() =>
//         window.open(`${API}${o.receiptUrl}`, "_blank")
//       }
//     />
//   </div>
// ) : (
...
//     if (!notes[id]) return toast.error("Notes required");
...
//     try {
//       await axios.delete(`${API}/orders/admin/${id}`, authHeader);
...
//       o.userId?.accountId?.toLowerCase().includes(q)
//     );
//   });

//   return (
//     <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#111827] to-black text-white p-6">
...
//         type="text"
//         placeholder="Search..."
//         className="w-full max-w-md mb-6 p-2 rounded-lg bg-black/40 border border-gray-700"
//         value={searchTerm}
//         onChange={(e) => setSearchTerm(e.target.value)}
//       />
...
//         <div
//           key={o._id}
//           className="bg-[#111827] p-5 rounded-xl mb-6 border border-gray-800"
//         >
//           {/* TOP ROW */}
...
//               <p className="text-indigo-400">#{o.userId?.accountId}</p>
//             </div>
...
//               <p className="text-green-400">₹ {o.totalINR}</p>
//             </div>
//           </div>
...
//               src={`${API}${o.receiptUrl}`}
//               alt="screenshot"
//               className="w-40 rounded-lg mb-4 cursor-pointer"
//               onClick={() =>
//                 window.open(`${API}${o.receiptUrl}`, "_blank")
//               }
//             />
...
//                 className="w-full p-2 mb-3 rounded-lg bg-black/40 border border-gray-700 text-sm"
//                 onChange={(e) =>
//                   setNotes({ ...notes, [o._id]: e.target.value })
//                 }
//               />

//               <div className="flex gap-3 flex-wrap">
//                 <button
//                   onClick={() => updateStatus(o._id, "SUCCESS")}
...
//                   className="px-4 py-2 bg-yellow-500 rounded-lg text-sm"
//                 >
//                   USDT Not Received
//                 </button>
      ...
      {filteredOrders.map((o) => (
        ...
        >
          ...
          <div className="flex justify-between items-center mb-4">
            <div>
              <p className="text-xs text-gray-400">Order ID</p>
              <p className="text-sm break-all">{o._id}</p>
            </div>
          ...
          {o.adminNotes && (
  <div className="bg-yellow-500/10 border border-yellow-500/20 p-3 rounded-lg text-sm mb-3">
    <p className="text-yellow-400 font-semibold">Admin Notes</p>
    <p className="text-gray-300">{o.adminNotes}</p>
  </div>
)}
